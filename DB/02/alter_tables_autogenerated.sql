...
ADD PRIMARY KEY (`id`),
ADD INDEX `country_title` (`title` ASC);
...
CHANGE COLUMN `title_ru` `title` VARCHAR(150) NOT NULL ,
ADD PRIMARY KEY (`id`),
ADD INDEX `region_index` (`title` ASC),
ADD INDEX `region_country_key_idx` (`country_id` ASC);
...
CHANGE COLUMN `title_ru` `title` VARCHAR(150) NOT NULL ,
ADD PRIMARY KEY (`id`),
ADD INDEX `city_title` (`title` ASC),
ADD INDEX `city_country_key_idx` (`country_id` ASC),
ADD INDEX `city_region_key_idx` (`region_id` ASC);
